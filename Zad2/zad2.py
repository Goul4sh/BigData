...
cols_to_int = ['cumulative_confirmed', 'new_confirmed', 'new_tested', 'new_deceased', 'cumulative_deceased', 'cumulative_persons_vaccinated', 'new_persons_vaccinated', 'cumulative_persons_fully_vaccinated', 'new_persons_fully_vaccinated']
...
df3['new_hospitalized_patients'] = df3['new_hospitalized_patients'].fillna(0)
df3["fatality_rate"] = np.where((df3['cumulative_deceased'] == 0) & (df3['population'] == 0), 0, (df3['cumulative_deceased'] / df3['population']) * 100)
df3["vaccination_rate"] = np.where((df3['cumulative_persons_fully_vaccinated'] == 0) & (df3['population'] == 0), 0, (df3['cumulative_persons_fully_vaccinated'] / df3['population']) * 100)
